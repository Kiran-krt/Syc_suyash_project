...
import com.syc.dashboard.query.jobcode.api.queries.FindAllActiveStatusJobCodeByIdQuery
...
@CrossOrigin
class FindAllActiveStatusJobCodeController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/jobcode/{id}/lookup/all/active")
    fun getCostCodeByFilter(
        @PathVariable id: String,
        request: ServerHttpRequest,
        response: ServerHttpResponse,
    ): ResponseEntity<Flux<out BaseDto>> {
        val query = buildQuery(FindAllActiveStatusJobCodeByIdQuery(id = id))
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get job code request!"
