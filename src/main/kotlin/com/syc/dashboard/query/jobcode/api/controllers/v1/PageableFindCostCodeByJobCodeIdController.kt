...
import com.syc.dashboard.query.jobcode.api.queries.PageableFindCostCodeByJobCodeIdQuery
...
@CrossOrigin
class PageableFindCostCodeByJobCodeIdController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/jobcode/{jobCodeId}/costcode/pageable/lookup/all")
    fun getCostCodeById(
        @PathVariable jobCodeId: String,
        query: PageableFindCostCodeByJobCodeIdQuery,
                ...
                .body(
                    Flux.just(
                        ErrorDto(
                            ...
                            errorCode = ErrorCodes.COSTCODE_FIND_BY_ID_FAILED,
                        ),
                    ),
                )
        }
