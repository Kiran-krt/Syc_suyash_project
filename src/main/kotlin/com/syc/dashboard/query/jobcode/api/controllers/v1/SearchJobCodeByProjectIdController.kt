...
@CrossOrigin
class SearchJobCodeByProjectIdController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/jobcode/project/lookup/search/all")
    fun searchJobCodeByFilter(
        query: SearchJobCodeByProjectIdQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to search jobcode by filter request!"
                ...
                .body(
                    Flux.just(
                        ErrorDto(
                            ...
                            errorCode = ErrorCodes.JOBCODE_FIND_BY_FILTER_FAILED,
                        ),
                    ),
                )
        }
