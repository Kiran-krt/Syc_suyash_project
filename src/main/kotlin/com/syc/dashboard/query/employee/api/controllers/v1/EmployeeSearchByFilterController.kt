...
@CrossOrigin
class EmployeeSearchByFilterController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/employee/lookup/search/all")
    fun searchEmployeeByStatus(
        query: EmployeeSearchByFilterQuery,
