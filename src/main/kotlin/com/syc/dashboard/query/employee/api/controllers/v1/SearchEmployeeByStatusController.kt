...
import com.syc.dashboard.query.employee.api.queries.SearchEmployeeByStatusQuery
...
@CrossOrigin
class SearchEmployeeByStatusController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/employee/pageable/lookup/bystatus/{status}")
    fun getEmployeeByStatus(
        @PathVariable status: EmployeeStatusEnum,
        query: SearchEmployeeByStatusQuery,
