...
@CrossOrigin
class PageableSearchAllProjectByFilterController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/project/pageable/lookup/all")
    fun getAllProject(
        query: PageableSearchAllProjectByFilterQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get all project by filter request!"
                ...
                .body(
                    Flux.just(
                        ErrorDto(
                            ...
                            errorCode = ErrorCodes.PROJECT_FIND_BY_FILTER_FAILED,
                        ),
                    ),
                )
        }
