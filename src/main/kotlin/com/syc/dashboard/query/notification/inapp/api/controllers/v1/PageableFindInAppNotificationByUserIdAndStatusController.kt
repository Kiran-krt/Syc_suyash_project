package com.syc.dashboard.query.notification.inapp.api.controllers.v1
...
@CrossOrigin
class PageableFindInAppNotificationByUserIdAndStatusController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/notification/inapp/pageable/lookup/search/all")
    fun getInAppNotificationByTenantId(
        query: PageableFindInAppNotificationByUserIdAndStatusQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get notification by id request!"
                ...
                .body(
                    Flux.just(
                        ErrorDto(
                            ...
                            errorCode = ErrorCodes.NOTIFICATION_IN_APP_NOT_FOUND,
                        ),
                    ),
                )
        }
