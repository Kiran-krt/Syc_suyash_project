...
@CrossOrigin
class InAppNotificationCountStatusController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/notification/inapp/count/bystatus")
    fun getTimesheetForAdmin(
        query: FindInAppNotificationCountStatusQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get notification count for inapp by status request!"
                ...
                .body(
                    Mono.just(
                        ErrorDto(
                            ...
                            errorCode = ErrorCodes.NOTIFICATION_COUNT_FIND_BY_IN_APP_BY_STATUS_FAILED,
                        ),
                    ),
                )
        }
