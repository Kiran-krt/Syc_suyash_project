...
@CrossOrigin
class MobileNotificationCountStatusController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/notification/mobile/count/bystatus")
    fun getTimesheetForAdmin(
        query: FindMobileNotificationCountStatusQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get notification count for mobile by status request!"
                ...
                .body(
                    Mono.just(
                        ErrorDto(
                            ...
                            errorCode = ErrorCodes.NOTIFICATION_COUNT_FIND_BY_MOBILE_BY_STATUS_FAILED,
                        ),
                    ),
                )
        }
