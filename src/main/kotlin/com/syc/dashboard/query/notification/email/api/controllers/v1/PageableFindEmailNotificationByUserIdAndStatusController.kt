...
@CrossOrigin
class PageableFindEmailNotificationByUserIdAndStatusController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/notification/email/pageable/lookup/search/all")
    fun getEmailNotificationByTenantId(
        query: PageableFindEmailNotificationByUserIdAndStatusQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get email notification by id request!"
                ...
                .body(
                    Flux.just(
                        ErrorDto(
                            ...
                            errorCode = ErrorCodes.NOTIFICATION_EMAIL_NOT_FOUND,
                        ),
                    ),
                )
        }
