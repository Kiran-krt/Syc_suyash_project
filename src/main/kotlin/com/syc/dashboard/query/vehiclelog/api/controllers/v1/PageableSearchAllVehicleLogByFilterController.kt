...
@CrossOrigin
class PageableSearchAllVehicleLogByFilterController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/vehiclelog/pageable/lookup/all")
    fun getAllVehicleLog(
        query: PageableSearchAllVehicleLogByFilterQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get all vehicle logs by filter request!"
                ...
                .body(
                    Flux.just(
                        ErrorDto(
                            ...
                            errorCode = ErrorCodes.VEHICLE_LOG_FIND_BY_FILTER_FAILED,
                        ),
                    ),
                )
        }
