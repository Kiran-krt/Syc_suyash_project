...
@CrossOrigin
class FindMdStandardNumberByIdController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/tvhgconfig/mdstandardnumber/lookup/bystructureclass")
    fun getMdStandardNumberByStructureClass(
        query: FindMdStandardNumberByIdQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get md standard number by id request!"
                ...
                .body(
                    Flux.just(
                        ErrorDto(
                            ...
                            errorCode = ErrorCodes.TVHG_CONFIG_MD_STANDARD_NUMBER_FIND_BY_ID_FAILED,
                        ),
                    ),
                )
        }
