...
@CrossOrigin
class PageableSearchTvhgInputController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/tvhginput/pageable/lookup/all")
    fun getTvhgInputFilter(
        query: PageableSearchAllTvhgInputQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get tvhg input request!"
                ...
                .body(
                    Flux.just(
                        ErrorDto(
                            ...
                            errorCode = ErrorCodes.TVHG_INPUT_NOT_FOUND,
                        ),
                    ),
                )
        }
