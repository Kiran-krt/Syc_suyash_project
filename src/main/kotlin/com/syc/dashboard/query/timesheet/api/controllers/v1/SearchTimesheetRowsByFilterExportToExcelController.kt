...
@CrossOrigin
class SearchTimesheetRowsByFilterExportToExcelController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/timesheet/timesheetrow/search/all/export/toexcel")
    fun getTimesheetByFilterExportToExcel(
        query: SearchTimesheetRowsByFilterExportToExcelQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get timesheet rows search request!"
                ...
                .body(
                    Flux.just(
                        ErrorDto(
                            ...
                            errorCode = ErrorCodes.TIMESHEET_ROWS_SEARCH_FAILED,
                        ),
                    ),
                )
        }
