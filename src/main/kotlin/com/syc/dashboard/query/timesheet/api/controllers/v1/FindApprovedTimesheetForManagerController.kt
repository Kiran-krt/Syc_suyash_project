...
import com.syc.dashboard.query.timesheet.api.queries.FindApprovedTimesheetForManagerQuery
...
@CrossOrigin
class FindApprovedTimesheetForManagerController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/timesheet/pageable/lookup/approved/formanager/{id}")
    fun getTimesheetForManager(
        @PathVariable("id") id: String,
        query: FindApprovedTimesheetForManagerQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get timesheet for manager by id request!"
