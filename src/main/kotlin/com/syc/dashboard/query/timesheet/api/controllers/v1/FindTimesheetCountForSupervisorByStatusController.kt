...
@CrossOrigin
class FindTimesheetCountForSupervisorByStatusController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/timesheet/count/forsupervisor/{id}/bystatus")
    fun getTimesheetCountyByStatusForSupervisor(
        @PathVariable("id") id: String,
        query: FindTimesheetCountForSupervisorByStatusQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get timesheet count for Supervisor by status request!"
                ...
                .body(
                    Mono.just(
                        ErrorDto(
                            ...
                            errorCode = ErrorCodes.TIMESHEET_COUNT_FIND_BY_SUPERVISOR_ID_AND_STATUS_FAILED,
                        ),
                    ),
                )
        }
