...
import com.syc.dashboard.query.timesheet.api.queries.FindTimesheetForEmployeeToReviewQuery
...
@CrossOrigin
class TimesheetFindForEmployeeToReviewController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/timesheet/pageable/lookup/tosubmit/foremployee/employee/{id}")
    fun getTimesheetForEmployeeToReview(
        @PathVariable("id") id: String,
        query: FindTimesheetForEmployeeToReviewQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get timesheet by id request!"
