...
import com.syc.dashboard.query.timesheet.api.queries.FindApprovedTimesheetForEmployeeQuery
...
@CrossOrigin
class TimesheetFindSubmittedForApprovedForEmployeeController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/timesheet/pageable/lookup/approved/foremployee/{id}")
    fun getTimesheetForEmployee(
        @PathVariable("id") id: String,
        query: FindApprovedTimesheetForEmployeeQuery,
