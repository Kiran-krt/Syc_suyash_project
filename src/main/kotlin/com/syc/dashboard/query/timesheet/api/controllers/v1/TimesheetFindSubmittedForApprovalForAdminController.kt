...
@CrossOrigin
class TimesheetFindSubmittedForApprovalForAdminController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping(
        value = [
            "/api/v1/timesheet/pageable/lookup/submittedforapproval/foradmin",
            "/api/v1/timesheet/pageable/lookup/submittedforapproval/forsupervisor",
        ],
    )
    fun getTimesheetByStatus(
        query: FindTimesheetSubmittedForApprovalForAdminQuery,
