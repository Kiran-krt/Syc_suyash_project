...
@CrossOrigin
class PageableSearchExpenseReportByFilterController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/expensereport/pageable/lookup/search/all")
    fun getExpenseReportByTenantId(
        query: PageableSearchExpenseReportByFilterQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get expense report request!"
                ...
                .body(
                    Flux.just(
                        ErrorDto(
                            ...
                            errorCode = ErrorCodes.EXPENSE_REPORT_FIND_FAILED,
                        ),
                    ),
                )
        }
