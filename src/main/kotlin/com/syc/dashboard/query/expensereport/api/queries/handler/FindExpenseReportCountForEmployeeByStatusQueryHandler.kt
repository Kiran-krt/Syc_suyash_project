...
class FindExpenseReportCountForEmployeeByStatusQueryHandler(
    private val expenseReportReactiveRepository: ExpenseReportReactiveRepository,
) : QueryHandler {

    override fun <T : BaseQuery> handle(query: T): Flux<out BaseDto> {
        query as FindExpenseReportCountForEmployeeByStatusQuery
        return expenseReportReactiveRepository
            .countByTenantIdAndEmployeeIdAndStatus(
