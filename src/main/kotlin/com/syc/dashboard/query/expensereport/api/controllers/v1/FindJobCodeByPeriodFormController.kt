...
import com.syc.dashboard.query.expensereport.api.queries.FindJobCodeByPeriodFromQuery
...
@CrossOrigin
class FindJobCodeByPeriodFormController @Autowired constructor(
    val queryDispatcher: QueryDispatcher,
) : RootController() {

    @GetMapping("/api/v1/expensereport/byperiodfrom/jobcode/lookup")
    fun getJobCodeByPeriodFrom(
        query: FindJobCodeByPeriodFromQuery,
        ...
        return try {
            ...
            val safeErrorMessage = "Failed to get jobcode by periodform request!"
                ...
                .body(
                    Flux.just(
                        ErrorDto(
                            ...
                            errorCode = ErrorCodes.JOBCODE_FIND_BY_PERIODFORM_FAILED,
                        ),
                    ),
                )
        }
