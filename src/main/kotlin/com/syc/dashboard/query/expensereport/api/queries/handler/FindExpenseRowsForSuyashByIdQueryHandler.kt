        ...
        return expenseReportRowReactiveRepository
            ...
            .map {
                ...
                if (it.expenseTypeInfo != null) {
                    expenseReportRowDto.expenseTypeInfo = EntityDtoConversion.toDto(it.expenseTypeInfo!!, ExpenseTypeDto::class)
                }
